            ...
            <div style={{ position: 'relative', top: '70px' }} className="text-center container">
                ...
                <div className="mt-5 d-flex justify-content-center">
                    <Form onSubmit={handleSubmit} style={{ width: '450px' }}>
                        {errors.name.length > 0 && <p style={{ fontSize: '20px', color: 'black' }} ><b>{errors.name}</b></p>}
                        {errors.email.length > 0 && <p style={{ fontSize: '20px', color: 'black' }} ><b>{errors.email}</b></p>}
                        {errors.password.length > 0 && <p style={{ fontSize: '20px', color: 'black' }} ><b>{errors.password}</b></p>}
                        {errors.confirmPassword.length > 0 && <p style={{ fontSize: '20px', color: 'black' }} ><b>{errors.confirmPassword}</b></p>}
                        <p style={{ fontSize: '20px', color: 'black' }} ><b>{msg}</b></p>
